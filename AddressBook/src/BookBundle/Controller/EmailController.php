...
class EmailController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $emails = $em->getRepository('BookBundle:Email')->findAll();
    ...
    {
        $email = new Email();
        $form = $this->createForm('BookBundle\Form\EmailType', $email);
    ...
    {
        $deleteForm = $this->createDeleteForm($email);
        $editForm = $this->createForm('BookBundle\Form\EmailType', $email);
