...
class PhoneController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $phones = $em->getRepository('BookBundle:Phone')->findAll();
    ...
    {
        $phone = new Phone();
        $form = $this->createForm('BookBundle\Form\PhoneType', $phone);
    ...
    {
        $deleteForm = $this->createDeleteForm($phone);
        $editForm = $this->createForm('BookBundle\Form\PhoneType', $phone);
